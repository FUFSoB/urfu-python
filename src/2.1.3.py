...
class Report:
    ...
    @classmethod
    def generate_pdf(
        cls, input_connect: InputConnect, template_name: str, filename: str
    ) -> None:
    ...
    @classmethod
    def get_render_rules(cls, input_connect: InputConnect) -> Dict[str, Any]:
        rules = {
...
if __name__ == "__main__":
    try:
        ...
        Report.generate_pdf(input_connect, "pdf_template.html", "report.pdf")
